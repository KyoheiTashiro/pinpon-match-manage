...
describe("DoublesList", () => {
  ...
  // -------------------------------------------------------------------------
  // 1. 参加者 4 人未満 → 案内表示・フォーム非表示
  // -------------------------------------------------------------------------
  it("参加者 3 人以下 → 「参加者を4人以上」案内が表示され、フォームは表示されない", () => {
    seedStore({
      tournaments: {
        t1: makeTournament({
          id: "t1",
  ...
  // -------------------------------------------------------------------------
  // 3. 参加者 4 人以上 → フォーム表示・Select 4 つ存在
  // -------------------------------------------------------------------------
  ...
  // -------------------------------------------------------------------------
  // 6. 4 つの Select で別々の選手を選ぶ → ボタン有効化 → クリックで match 追加 & Modal 開く
  // -------------------------------------------------------------------------
  ...
  // -------------------------------------------------------------------------
  // 7. 既存 doubles match(PAIR side) を seed → 一覧表示
  // -------------------------------------------------------------------------
  ...
  // -------------------------------------------------------------------------
  // 8. 既存 doubles match に勝利スコアを seed → 勝者表示
  // -------------------------------------------------------------------------
  ...
  // -------------------------------------------------------------------------
  // 10. 同一選手重複選択でボタン disabled (refine バリデーション)
  // -------------------------------------------------------------------------
  ...
  // -------------------------------------------------------------------------
  // 12. 試合追加後フォームがリセットされ、ボタンが再び disabled になる
  // -------------------------------------------------------------------------
  ...
  // -------------------------------------------------------------------------
  // 14. SaveImageButton は参加者 4 人以上かつ試合 1 件以上で表示される
  // -------------------------------------------------------------------------
