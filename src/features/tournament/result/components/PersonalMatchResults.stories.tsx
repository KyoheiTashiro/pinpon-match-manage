...
const matches: PersonalMatchRow[] = [
  {
    ...
    opponentWins: 1,
    games: [
      { selfScore: 11, opponentScore: 9 },
      { selfScore: 9, opponentScore: 11 },
      { selfScore: 11, opponentScore: 5 },
      { selfScore: 11, opponentScore: 7 },
    ],
    result: "win",
  },
  {
    ...
    opponentWins: 3,
    games: [
      { selfScore: 11, opponentScore: 8 },
      { selfScore: 7, opponentScore: 11 },
      { selfScore: 9, opponentScore: 11 },
      { selfScore: 5, opponentScore: 11 },
    ],
    result: "lose",
  },
];
...
const straightWin: PersonalMatchRow = {
  ...
  opponentWins: 0,
  games: [
    { selfScore: 11, opponentScore: 4 },
    { selfScore: 11, opponentScore: 2 },
    // { selfScore: 11, opponentScore: 6 },
  ],
  result: "win",
};
...
const deuceMatch: PersonalMatchRow = {
  ...
  opponentWins: 2,
  games: [
    { selfScore: 13, opponentScore: 11 },
    { selfScore: 9, opponentScore: 11 },
    { selfScore: 14, opponentScore: 12 },
    { selfScore: 10, opponentScore: 12 },
    { selfScore: 12, opponentScore: 10 },
  ],
  result: "win",
};
